...
public class StringUtils {
	...
	public static final char[] CHAR_ARRS = new char[] { 'q', 'w', 'e', 'r', 't', 'y', 'u', 'i', 'o', 'p', 'a', 's', 'd', 'f', 'g', 'h', 'j', 'k', 'l', 'z', 'x', 'c', 'v', 'b', 'n', 'm', '1', '2', '3', '4', '5', '6', '7', '8', '9' };
	...
	/**
	 * 将对象转换为json(去除值为null的属性)
	 * 
	 * @param obj
	 *            对象
	 * @return 对象为null返回null，否则返回json
	 */
	public static String jsonNotNULL(Object obj) {
		if (null != obj) {
			try {
	 ...
	 * @return redirect:/地址
	 */
	public static String redirect(String url, String dau) {
		String s = StringUtils.trim(url);
		if (null == s && null != dau) {
			s = StringUtils.trim(dau);
		}
		if (null != s) {
			if (s.charAt(0) == '/') {
				s = s.replaceFirst("[/]+", "");
