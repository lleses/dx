package cn.dc.utils;
//package cn.sini.zszw.common.query;
//
...
//
//import cn.sini.zszw.common.dto.Page;
//import cn.sini.zszw.common.entity.AbstractEntity;
//import cn.sini.zszw.common.util.CommonUtils;
//import cn.sini.zszw.common.util.Environment;
//
///**
// * 查询抽象类
// * 
...
//public abstract class AbstractQueryBack {
//
...
//
//	/** 添加ID查询条件 */
//	public AbstractQueryBack id(Serializable... id) {
...
//
//	/** 添加ID不等于查询条件 */
//	public AbstractQueryBack idNotIn(Serializable... id) {
//		Object[] values = CommonUtils.removeEmptyElement(id);
//		if (ArrayUtils.isNotEmpty(values)) {
//			if (values.length == 1) {
...
//
//	/** 添加统计规则 */
//	public AbstractQueryBack rowCount() {
//		addProjection(Projections.rowCount());
//		return this;
//	}
//
//	/** 添加分组规则 */
//	public AbstractQueryBack groupBy(String propertyName) {
...
//
//	/** 添加分组规则，并指定分组别名 */
//	public AbstractQueryBack groupBy(String propertyName, String alias) {
//		if (StringUtils.isNotEmpty(propertyName)) {
...
//
//	/** 添加排序规则 */
//	public AbstractQueryBack orderBy(String propertyName, boolean asc) {
//		if (StringUtils.isNotEmpty(propertyName)) {
...
//
//	/** 设置查询注释 */
//	public AbstractQueryBack comment(String comment) {
//		this.comment = comment;
//		return this;
//	}
//
//	/** 设置Hibernate Session对象 */
//	public AbstractQueryBack session(Session session) {
//		this.session = session;
//		return this;
//	}
//
//	/** 启用查询结果只读 */
//	public AbstractQueryBack readOnly() {
//		this.readOnly = true;
//		return this;
//	}
//
//	/** 设置数据库锁模式 */
//	public AbstractQueryBack lockMode(LockMode lockMode) {
//		this.lockMode = lockMode;
//		return this;
//	}
//
//	/** 设置查询结果转换器 */
//	public AbstractQueryBack resultTransformer(ResultTransformer resultTransformer) {
...
//
//	/** 添加投影规则，并指定投影字段别名 */
//	protected void addProjection(Projection projection, String alias) {
...
//	protected void addCriteria(String propertyName, AbstractQueryBack query) {
//		addCriteria(propertyName, JoinType.INNER_JOIN, query);
//	}
//
//	/** 添加多表连接查询规则 */
//	protected void addCriteria(String propertyName, JoinType joinType, AbstractQueryBack query) {
...
//
//	/** 组装Criteria对象 */
//	private void assembleCriteria(Criteria criteria) {
...
//			String propertyName = (String) map.get("propertyName");
//			JoinType joinType = (JoinType) map.get("joinType");
//			AbstractQueryBack query = (AbstractQueryBack) map.get("query");
//			Criteria subCriteria = criteria.createCriteria(propertyName, query.queryEntity().getSimpleName(), joinType);
